<?php  include "includes/db.php"; ?>
 ...
 <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $query = "INSERT INTO admins (admin_username, admin_email, admin_password, admin_firstname, admin_lastname)";
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-6 col-xs-offset-3">
                <div class="form-wrap">
                <h1>ADMIN REGISTER TEST </h1>
                    <form role="form" action="admin_registration.php" method="post" id="login-form" autocomplete="off">
