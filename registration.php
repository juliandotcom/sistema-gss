<?php  include "includes/db.php"; ?>
 ...
 <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $query = "INSERT INTO parents (par_username, par_email, par_password, par_firstname, par_lastname)";
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-6 col-xs-offset-3">
                <div class="form-wrap">
                <h1>Registrar Cuenta de Pariente</h1>
                    <form role="form" action="registration.php" method="post" id="login-form" autocomplete="off">
                        ...
                        <input type="submit" name="submit" id="btn-login" class="btn btn-custom btn-lg btn-block" value="Registrar">
                    </form>
