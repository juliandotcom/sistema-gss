<?php  include "includes/db.php"; ?>
 ...
 <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $query = "INSERT INTO teachers (tea_username, tea_email, tea_password, tea_firstname, tea_lastname)";
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-6 col-xs-offset-3">
                <div class="form-wrap">
                <h1>Register</h1>
                    <form role="form" action="teacher_registration.php" method="post" id="login-form" autocomplete="off">
