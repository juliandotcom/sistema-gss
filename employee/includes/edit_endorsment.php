<?php
    ...
    if(isset($_POST['update_endorsment'])){
        ...
        "UPDATE endorsments SET 
            ...
            end_revision_date       = now(),
            end_employee_id         = '{$end_employee_id}'
        WHERE end_id = '{$the_end_id}' ";
        ...
        echo "<p class='bg-success'>Referido Actualizado. <a href='../endorsment_tab.php?p_id={$the_end_id}'>Ver Referido </a>
...
<?php
                ...
                $tea_fullname = $row['tea_firstname'] . ' ' . $row['tea_lastname'];
                    ...
                    echo "<input disabled class='form-control' type='text' name='end_teacher_id' value='{$tea_fullname}'>";
                }
?>
                    </div>
            ...
            <div class="form-group">
                ...
                value="<?php echo $_SESSION['user_role'] . ' - ' . $_SESSION['firstname'] . ' ' . $_SESSION['lastname'] ?>"id="">
            </div> <!-- Verified -->
