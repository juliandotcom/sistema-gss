...
<!-------------------------------------------------------------------------------------------------------------------------->
                    ...
                    <!-- EMPLOYEES DROP DOWN -->
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#employees">
                        <i class="fas fa-address-card"></i> Empleados <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="employees" class="collapse">
                            <li>
                                <a href="employees.php">Ver Empleados</a>
                            </li>
                            <li>
                                <a href="employees.php?source=add_employee">Crear Empleado</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <i class="far fa-address-card"></i> Administradores <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="admin" class="collapse">
                            <li>
                                <a href="users.php">Ver Administradores</a>
                            </li>
                            <li>
                                <a href="users.php?source=add_user">Crear Administrador</a>
                            </li>
                        </ul>
                    </li>
