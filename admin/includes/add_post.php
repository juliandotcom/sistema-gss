...
<?php
    ...
    $create_post_query = mysqli_query($connection, $query);
      ...
      echo "<p class='bg-success'>Post Updated. <a target='_blank' rel='noopener noreferrer' href='../post.php?p_id={$the_post_id}'>View Post </a> or <a href='posts.php'>View All Posts</a></p>";
...
?>
    ...
    <div class="form-group">
        ...
        <!-- <input type='text' class='form-control' name='post_user' value='{$user_username}'>"; -->
    ...
    <div class="form-group">
        <label for="post_image_temp">Post Image</label>
